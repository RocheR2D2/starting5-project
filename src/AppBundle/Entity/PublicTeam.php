 ...
 * PublicTeam
 *
 * @ORM\Table(name="public_team")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\PublicTeamRepository")
 */
class PublicTeam
{
    /**
    ...
    private $name;
    /**
     * @ORM\ManyToOne(targetEntity="NBAPlayers", inversedBy="publicTeam")
    ...
    public $center;
    /**
     * @ORM\ManyToOne(targetEntity="Trainer", inversedBy="publicTeam")
     * @ORM\JoinColumn(name="trainer_id", referencedColumnName="id")
     */
    private $trainerId;
    /**
     * @ORM\ManyToOne(targetEntity="Stadium", inversedBy="publicTeam")
